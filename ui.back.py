...
class MyFrame1 ( wx.Frame ):
	...
	def __init__( self, parent ):
		wx.Frame.__init__ ( self, parent, id = wx.ID_ANY, title = u"鑫山财务-发票导出辅助工具", pos = wx.DefaultPosition, size = wx.Size( 450,365 ), style = wx.DEFAULT_FRAME_STYLE ^ wx.RESIZE_BORDER ^ wx.MAXIMIZE_BOX|wx.TAB_TRAVERSAL )
		...
		self.m_menubar1.Append( self.m_menu6, u"设置" ) 
